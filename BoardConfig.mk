...
BOARD_KERNEL_CMDLINE += earlycon=msm_hsl_uart,0x78af000000
...
# Partitions
CHERRY_SYSTEM_SIZE := 3221225472
CHERRY_VENDOR_SIZE := 811597824
...
BOARD_SUPER_PARTITION_VENDOR_DEVICE_SIZE := $(CHERRY_VENDOR_SIZE)
BOARD_SUPER_PARTITION_SYSTEM_DEVICE_SIZE := $(CHERRY_SYSTEM_SIZE)
BOARD_SUPER_PARTITION_SIZE := $(shell expr $(BOARD_SUPER_PARTITION_VENDOR_DEVICE_SIZE) + $(BOARD_SUPER_PARTITION_SYSTEM_DEVICE_SIZE) )

BOARD_SUPER_PARTITION_GROUPS := casuarina_dynpart
BOARD_CASUARINA_DYNPART_SIZE := $(shell expr $(BOARD_SUPER_PARTITION_SIZE) - 4194304 )
BOARD_CASUARINA_DYNPART_PARTITION_LIST := $(ALL_PARTITIONS)

# Dynamic - reserved size
...
BOARD_SYSTEMIMAGE_PARTITION_SIZE := $(CHERRY_SYSTEM_SIZE)
BOARD_VENDORIMAGE_PARTITION_SIZE := $(CHERRY_VENDOR_SIZE)
endif
